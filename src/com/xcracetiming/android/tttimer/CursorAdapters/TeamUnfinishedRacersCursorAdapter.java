...
public class TeamUnfinishedRacersCursorAdapter extends BaseCursorAdapter  {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
    	...
    	try{	  
    		final LayoutInflater inflater = LayoutInflater.from(context);
    		v = inflater.inflate(com.xcracetiming.android.tttimer.R.layout.row_unfinished_racer, parent, false);
	         ...
	         */		        
	        TextView lblName = (TextView) v.findViewById(com.xcracetiming.android.tttimer.R.id.lblName);
	        if (lblName != null) {
	        	lblName.setText(teamName);
	        }
	        
	        TextView lblStartOrder = (TextView) v.findViewById(com.xcracetiming.android.tttimer.R.id.lblStartPosition);
	        if (lblStartOrder != null) {
	        	lblStartOrder.setText(startOrder.toString());
	        }
	        
	        TextView lblLaps = (TextView) v.findViewById(com.xcracetiming.android.tttimer.R.id.lblLaps);
	        if (lblLaps != null) {
