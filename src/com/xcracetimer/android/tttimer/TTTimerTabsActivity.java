package com.xcracetimer.android.tttimer;
...
import com.xcracetimer.android.tttimer.AsyncTasks.AllRacersFinishedTask;
...
import com.xcracetimer.android.tttimer.Dialogs.AddMeetView;
import com.xcracetimer.android.tttimer.Dialogs.OtherRaceResults;
import com.xcracetimer.android.tttimer.Tabs.FinishTab;
import com.xcracetimer.android.tttimer.Tabs.OtherTab;
import com.xcracetimer.android.tttimer.Tabs.RaceInfoTab;
import com.xcracetimer.android.tttimer.Tabs.ResultsTab;
import com.xcracetimer.android.tttimer.Tabs.StartTab;
import com.xcracetimer.android.tttimer.Utilities.TabManagerContainer;
...
public class TTTimerTabsActivity extends FragmentActivity {
	 ...
	 */
	public static final String RACE_ID_CHANGED_ACTION = "com.xcracetimer.android.tttimer.RACE_ID_CHANGED";

	/**
	 * This action is fired when a new racer is on deck
	 */
	public static final String CHANGE_VISIBLE_TAB = "com.xcracetimer.android.tttimer.CHANGE_VISIBLE_TAB";
	...
	private boolean IsRaceInProgress(Cursor theRace){
		...
		try{			
			if(theRace.getCount() > 0 && theRace.isNull(theRace.getColumnIndex(RaceResults.EndTime)) && 
			   !theRace.isNull(theRace.getColumnIndex(RaceResults.StartTime))){	
				theRace.moveToFirst();
				Long raceID = theRace.getLong(theRace.getColumnIndex(Race._ID));
				if(System.currentTimeMillis() < theRace.getLong(theRace.getColumnIndex(RaceResults.StartTime)) + 86400000)
				{				
...
//			   ((!theRace.isNull(theRace.getColumnIndex(RaceResults.StartTime)) && theRace.getLong(theRace.getColumnIndex(RaceResults.StartTime)) > 0) ||
