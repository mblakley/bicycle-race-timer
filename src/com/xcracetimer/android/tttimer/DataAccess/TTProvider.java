...
import com.xcracetimer.android.tttimer.DataAccess.LookupGroupsCP.LookupGroups;
import com.xcracetimer.android.tttimer.DataAccess.PrimesCP.Primes;
...
import com.xcracetimer.android.tttimer.DataAccess.RaceInfoViewCP.RaceInfoResultsView;
...
import com.xcracetimer.android.tttimer.DataAccess.RaceInfoViewCP.UnassignedTimesView;
...
import com.xcracetimer.android.tttimer.DataAccess.RaceLapsCP.TeamLaps;
...
import com.xcracetimer.android.tttimer.DataAccess.RaceNotesCP.RaceNotes;
...
import com.xcracetimer.android.tttimer.DataAccess.RacerPreviousResultsViewCP.RacerPreviousResultsView;
import com.xcracetimer.android.tttimer.DataAccess.TeamInfoCP.TeamInfo;
import com.xcracetimer.android.tttimer.DataAccess.TeamRacesCP.TeamRaces;
...
public class TTProvider extends ContentProvider {
	...
	// Database located at /data/data/com.xcracetimer.android.tttimer/databases/GVCCRaces
	public static final String PROVIDER_NAME = "com.xcracetimer.android.tttimer.DataAccess.TTProvider";
	...
	public static class DatabaseHelper extends SQLiteOpenHelper 
	{
	    ...
	    public void onCreate(SQLiteDatabase db) 
	    {
			...
			// East High
			db.execSQL("INSERT INTO " + TeamInfo.getTableName() + "(" + TeamInfo.TeamName + "," + TeamInfo.Year + "," + TeamInfo.Division + "," + TeamInfo.DivisionWins + "," + TeamInfo.DivisionLosses + "," + TeamInfo.OverallWins + "," + TeamInfo.OverallLosses + ") VALUES ('East High', 2012, 4, 0, 0, 0, 0)");
			// Edison Tech
			db.execSQL("INSERT INTO " + TeamInfo.getTableName() + "(" + TeamInfo.TeamName + "," + TeamInfo.Year + "," + TeamInfo.Division + "," + TeamInfo.DivisionWins + "," + TeamInfo.DivisionLosses + "," + TeamInfo.OverallWins + "," + TeamInfo.OverallLosses + ") VALUES ('Edison Tech', 2012, 1, 0, 0, 0, 0)");
			// Fairport
			...
			// Franklin
			db.execSQL("INSERT INTO " + TeamInfo.getTableName() + "(" + TeamInfo.TeamName + "," + TeamInfo.Year + "," + TeamInfo.Division + "," + TeamInfo.DivisionWins + "," + TeamInfo.DivisionLosses + "," + TeamInfo.OverallWins + "," + TeamInfo.OverallLosses + ") VALUES ('Franklin', 2012, 1, 0, 0, 0, 0)");
			// Gates Chili
			...
			// McQuaid
			db.execSQL("INSERT INTO " + TeamInfo.getTableName() + "(" + TeamInfo.TeamName + "," + TeamInfo.Year + "," + TeamInfo.Division + "," + TeamInfo.DivisionWins + "," + TeamInfo.DivisionLosses + "," + TeamInfo.OverallWins + "," + TeamInfo.OverallLosses + ") VALUES ('McQuaid', 2012, 3, 0, 0, 0, 0)");
			// Mendon
			...
			// W. Schroeder
			db.execSQL("INSERT INTO " + TeamInfo.getTableName() + "(" + TeamInfo.TeamName + "," + TeamInfo.Year + "," + TeamInfo.Division + "," + TeamInfo.DivisionWins + "," + TeamInfo.DivisionLosses + "," + TeamInfo.OverallWins + "," + TeamInfo.OverallLosses + ") VALUES ('Webster Schroeder', 2012, 1, 0, 0, 0, 0)");
			// Spencerport
			...
			db.execSQL("INSERT INTO " + RaceLocation.getTableName() + "(" + RaceLocation.CourseName + ") VALUES ('GCC')");
