...
import com.xcracetimer.android.tttimer.AsyncTasks.ImportRacersTask;
import com.xcracetimer.android.tttimer.AsyncTasks.UploadUSACNumbersToDropboxTask;
...
public class AdminMenuView extends BaseDialog implements View.OnClickListener {
     ...
     * Used for dropbox
     */
    final static private String APP_KEY = "qrzaqxwrxuo19xv";
    final static private String APP_SECRET = "jcqgr66o4ll3xzo";
...
//				editRaceDialog.show(fm, EditRaceMeetConfiguration.LOG_TAG);
	...
	private void RecalculateResults() {
    	Calculations.CalculateCategoryPlacings(getActivity(), Long.parseLong(AppSettings.ReadValue(getActivity(), AppSettings.AppSetting_RaceID_Name, "0")), Long.parseLong(AppSettings.ReadValue(getActivity(), AppSettings.AppSetting_TeamID_Name, "0")));
