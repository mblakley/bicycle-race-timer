...
public class TeamCheckInCursorAdapter extends BaseCursorAdapter {
    ...
    public void bindView(View v, Context context, Cursor c) {
    	...
    	try{
	        ...
	        Cursor raceResult = RaceResults.Instance().Read(context, new String[]{RaceResults._ID}, RaceResults.TeamInfo_ID + "=? AND " + RaceResults.Race_ID + "=" + AppSettings.Instance().getParameterSql(AppSettings.AppSetting_RaceID_Name), new String[]{Integer.toString(teamInfo_ID)}, null);
	        /**
