...
public final class Racer extends ContentProviderTable implements BaseColumns {
	...
	public int Update(Context context, long racer_ID, String firstName, String lastName, Long birthDate, 
		...
		int numChanged = context.getContentResolver().update(CONTENT_URI, content, Racer._ID + "=?", new String[]{Long.toString(racer_ID)});
