...
public class RaceResultsCP {
    ...
    public static final class RaceResults implements BaseColumns {
        ...
        public static Uri[] getAllUrisToNotifyOnChange(){
        	return new Uri[]{RaceResults.CONTENT_URI, CheckInViewInclusive.CONTENT_URI, CheckInViewExclusive.CONTENT_URI, TeamCheckInViewInclusive.CONTENT_URI, TeamCheckInViewExclusive.CONTENT_URI, RaceResultsTeamOrRacerView.CONTENT_URI};
        }
